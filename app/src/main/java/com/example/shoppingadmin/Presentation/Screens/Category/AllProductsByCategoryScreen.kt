...
fun AllProductsByCategoryScreen(
    ...
    LaunchedEffect(CategoryName) {
        viewModel.getAllProductByCategory(CategoryName)
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = { viewModel.getAllProductByCategory(CategoryName) }) {
                        Icon(
            ...
            when {
                ...
                productState.Error != null -> {
                    ErrorState(
                        ...
                        onRetry = { viewModel.getAllProductByCategory(CategoryName) }
                    )
                }
